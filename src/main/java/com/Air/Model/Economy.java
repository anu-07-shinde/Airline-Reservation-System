...
public class Economy {
	...
	public Economy(String passportNo, String firstname, String lastname, String nationality, String emailid,
	...
	public String toString() {
		return "Economy [PassportNo=" + PassportNo + ", firstname=" + firstname + ", lastname=" + lastname

...
<div class="row">
  <div class="col-75">
    <div class="container">
                                   <form action="payhotelroom">
      
        <div class="row">
          <div class="col-50">
            <h3>Billing Address</h3>
            <label for="fname"><i class="fa fa-user"></i> Full Name</label>
          1  <input type="text" id="fname" name="firstname" placeholder="Sahil Mheta">
            <label for="email"><i class="fa fa-envelope"></i> Email</label>
           2 <input type="text" id="email" name="email" placeholder="sahilMheta@gmail.com">
            ...
            <div class="row">
              ...
              <div class="col-50">
                ...
                6<input type="text" id="zip" name="zip" placeholder="444606">
              </div>
            </div>
          </div>
          ...
          <div class="col-50">
           ...
           7 <input type="text" id="cname" name="cardname" placeholder="Sahil Mheta">
        ...
        <label>
         ...
         <input type="submit"  value="Pay" onclick="alert('hotel Booked Successful')" class="btn">

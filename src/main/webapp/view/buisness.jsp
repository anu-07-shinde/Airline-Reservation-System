...
<h3><marquee>Note-This is Buisness Class Ticket Booking Page</marquee></h3>
<h2>Welcome To Buisness Class Ticket Booking </h2>
<h3>IndainAirways Standard booking from England To India !</h3>

<div class="container">
  <form action="buisness" method="post">
  
   <label for="id">PassportNo</label>
    <input type="text"  name="PassportNo" placeholder="Your passportno..">
   ...
   <input type="text" name="DOB" placeholder="Your dob">
    ...
    <input type="submit" value="Submit" onclick="alert('Details Submitted now click on Pay here')">
    
  </form> <br>
  
  <form action="paybuisnessclass">

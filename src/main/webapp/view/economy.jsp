...
<body>
<h3><marquee>Note-This is Economy Class Ticket Booking Page !!</marquee></h3>
...
<h3>IndianAirways Economy booking from Indian To England !</h3>
...
<div class="container">
  <form action="economy" method="post">
   ...
   <input type="text" name="DOB" placeholder="Your dob">
    ...
    <input type="submit" onclick="alert('Details submitted now tap on pay here button')" value="Submit">

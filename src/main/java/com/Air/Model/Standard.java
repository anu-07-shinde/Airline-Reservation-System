...
public class Standard {
	...
	public Standard(String passportNo, String firstname, String lastname, String nationality, String emailid,
	...
	public String toString() {
		return "Standard [PassportNo=" + PassportNo + ", firstname=" + firstname + ", lastname=" + lastname
